...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo "<th>".$row["named"]."</th>";
    echo "<th>".$row["area"]."</th>";
    echo"<th><a href='eliminardoc.php?dat=".$row["id"]."'><button type='button' class='btn btn-danger'></button></a></th>";
    echo"<th><a href='editar-doctor.php?dat=".$row["id"]."'><button type='button' class='btn btn-success'></button></a></th>";
   echo" </tr>";
